...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def->tooltip = L("After a tool change, the exact position of the newly loaded filament inside "
                     ...
                     "Before purging the print head into an infill or a sacrificial object, ElegooSlicer will always prime "
    ...
    def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
                     "If expressed as percentage (example: 15%) it is calculated over infill extrusion width. ElegooSlicer tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
    ...
    def->tooltip = L("If you want to process the output G-code through custom scripts, "
                   ...
                   "and they can access the ElegooSlicer config settings by reading environment variables.");
    def->gui_flags = "serialized";
    def->multiline = true;
    def->full_width = true;
    def->height = 6;
