                                                        ...
                                                        ForwardCompatibilitySubstitutionRule    rule)
{
    ...
    for (auto &file : files) {
        ...
        if (boost::iends_with(file, ".elegoo_printer") || boost::iends_with(file, ".elegoo_filament") || boost::iends_with(file, ".zip")) {
...
void PresetBundle::update_selections(AppConfig &config)
{
    ...
    filament_colors.resize(filament_presets.size(), "#36A8E1");
