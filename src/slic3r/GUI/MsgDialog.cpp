...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "ElegooSlicer", this, 64, style & wxICON_ERROR));
}
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is in Beta and it is newer than the current ElegooSlicer  version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try ElegooSlicer Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current ElegooSlicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your ElegooSlicer could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
