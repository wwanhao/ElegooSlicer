...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        ...
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Elegoo Slicer Beta, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Elegoo Slicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Elegoo Slicer could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
