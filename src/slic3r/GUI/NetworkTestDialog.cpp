...
wxBoxSizer* NetworkTestDialog::create_info_sizer(wxWindow* parent)
{
	...
	text_version_title = new wxStaticText(this, wxID_ANY, _L("ElegooSlicer Version:"), wxDefaultPosition, wxDefaultSize, 0);
...
wxBoxSizer* NetworkTestDialog::create_content_sizer(wxWindow* parent)
{
	...
	text_link_title = new wxStaticText(this, wxID_ANY, _L("Test ElegooSlicer(GitHub):"), wxDefaultPosition, wxDefaultSize, 0);
