...
-(void)add_observer:(NSString *)version_hash
{
	...
	//NSString *nsver = @"OtherElegooSlicerInstanceMessage" + version_hash;
	NSString *nsver = [NSString stringWithFormat: @"%@%@", @"OtherElegooSlicerInstanceMessage", version_hash];
	...
	NSString *nsver2 = [NSString stringWithFormat: @"%@%@", @"OtherElegooSlicerInstanceClosing", version_hash];
...
void send_message_mac(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherElegooSlicerInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherElegooSlicerInstanceMessage", nsver];
...
void send_message_mac_closing(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherElegooSlicerInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherElegooSlicerInstanceClosing", nsver];
	[[NSDistributedNotificationCenter defaultCenter] postNotificationName:notifname object:nil userInfo:[NSDictionary dictionaryWithObject:nsmsg forKey:@"data"] deliverImmediately:YES];
}
