...
static const wxColour BUTTON_HOVER_COL   = wxColour(40, 40, 255);
...
static const wxColour STAGE_TEXT_COL      = wxColour(40, 40, 255);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(40, 40, 255));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(40, 40, 255));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(40, 40, 255));
    });
