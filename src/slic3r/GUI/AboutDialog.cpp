    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("ElegooSlicer_192px.png"), wxBITMAP_TYPE_PNG);
...
// #endif
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "", wxDefaultPosition, wxDefaultSize);
